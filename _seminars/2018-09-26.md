...
text_override_seminar_page: |
  ...
  - Send an email to speak [at] dub [dot] washington [dot] edu.
    ...
    Sending this email is your homework from the lunch. It can be short, but it is expected as part of reimbursement.

  - Consider signing up to host an activity this quarter, on our small group activity dates:
