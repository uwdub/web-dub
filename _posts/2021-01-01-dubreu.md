...
<div class="col-md-8" markdown="block">
Amy Zhang <axz [at] cs.uw.edu>, Tanushree Mitra <tmitra [at] uw.edu>
</div>
</div>
...
### REU Program Dates
The formal program begins on June 20 with a welcome reception and orientation, then concludes on August 20 with an afternoon poster session. Students are expected to present and engaged for the entire 9-week period, work 40 hours a week, and make time to attend scheduled events such as the welcome reception, seminar, and final poster session.
...
Students can receive a maximum stipend of $8,000 over the entire summer, but amounts will vary by funding source and duration of the internship. 
Many REU positions are funded through an NSF source, and the NSF provides guidance that a stipend should be $600 per student per week.
...
## Application Instructions for Summer 2021
...
<div class="col-md-8" markdown="block">
Deadline for applications is Jan 24, 2021
</div>
</div>
...
<div class="col-md-8" markdown="block">
<https://forms.gle/zpy7xquRDnVkfoNP8>
</div>
</div>

In addition to completing the above form, please have one recommender email a letter of recommendation to Amy Zhang <axz [at] cs.uw.edu> to complete your application.
